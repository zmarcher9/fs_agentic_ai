...
def run_simulation_tool(params_json: str) -> str:
    """Run FireMapSim with the given simulation parameters (JSON matching SimulationInput).
    ...
    """
    pass  # TODO: parse params_json -> SimulationInput; client.run_simulation(); return output.model_dump_json()


def run_simulation(params: SimulationInput, client: FireMapSimClient | None = None) -> SimulationOutput:
